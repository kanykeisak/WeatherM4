...
import com.example.weather.view.adapters.DayItemAdapter
import com.example.weather.view.adapters.HourItemAdapter
import com.example.weather.databinding.FragmentWeatherBinding
import com.example.weather.model.models.LocationKeysEnum
        ...
        viewModel.currentWeather.observe(viewLifecycleOwner) { currentWeather ->
            ...
            currentWeather.first().apply {
                ...
                when (hasPrecipitation) {
                    true -> binding.ivIcon.setImageResource(R.drawable.image_cloud_rain)
                    false -> binding.ivIcon.setImageResource(R.drawable.image_sun_cloud)
